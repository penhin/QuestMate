...
def answer_system_prompt() -> str:
    return (
        ...
        "claims or state the evidence limit conservatively. citation_claims is the source-indexed claim ledger: use it "
        "to select supporting indexes, and do not state a concrete fact unless a claim row directly supports it. Keep "
        "the cited index from that row immediately after the sentence or bullet it supports. "
